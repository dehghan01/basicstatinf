...
Note, the red bell-curve is the plotted true normal $N(0, \frac{1}{sqrt{40}})$ and the black curve is the simulated data with $\bar{X}_n=`r signif(mean(m1), 1)`$ and  $\sigma=`r signif(sd(m1), 1)`$.
